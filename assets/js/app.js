...
function init() {
  ...
  $('.open-inquire').click(function (e){
    $(this).parent().next().toggleClass('active')
    $(this).css('display', 'none')
  })
  $('.inquire-form .form__close').click(function (e){
    $('.open-inquire').css('display', '')
    $('.inquire-form').removeClass('active')
  })

  if ($(".artists__swiper ").length > 0) {
    new Swiper(".artists__swiper", {
      ...
      autoHeight: true,
      navigation: {
        nextEl: '.artists__swiper-next',
        prevEl: '.artists__swiper-prev',
      },
    });
  }
